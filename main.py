# tkinter is the standard python library for creating Graphical User Interface(GUI)
from tkinter import *
...
lab_txt = Label(root, text="Source Text", font=("Time New Roman", 20, "bold"), fg="black", bg="lightblue")
...
lab_txt = Label(root, text="Destination Text", font=("Time New Roman", 20, "bold"), fg="black", bg="lightblue")
